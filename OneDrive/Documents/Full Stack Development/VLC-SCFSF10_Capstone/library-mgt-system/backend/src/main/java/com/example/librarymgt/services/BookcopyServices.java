...
public class BookcopyServices {
	...
	public Optional<Bookcopy> getBookcopyById(Long copyid) {
		...
		return bookcopyr.findById(copyid); //returns the book copy if found, otherwise null
	}
	...
	public Bookcopy updateBookcopy(Long copyid, Bookcopy bookcopyDetails) {
		// Use BookcopyRepository to find the book copy by ID
		Bookcopy existingBookcopy = bookcopyr.findById(copyid)
	...
	public void deleteBookcopy(Long copyid) {
		bookcopyr.deleteById(copyid); //delete the book copy by ID
	}
}
