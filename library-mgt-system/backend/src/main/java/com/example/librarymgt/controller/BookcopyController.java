...
public class BookcopyController {
	...
	public Optional<Bookcopy> getBookcopyById(@PathVariable Long id) {
		// This method will handle the retrieval of a book copy by ID
		return bookcopyServices.getBookcopyById(id); //call the service to get the book copy by ID
	...
	public Bookcopy updateBookcopy(@PathVariable Long id, @RequestBody Bookcopy bookcopy) {
		...
		// It will receive a Bookcopy object from the request body
		return bookcopyServices.updateBookcopy(id, bookcopy); //call the service to update the book copy
	...
	public void deleteBookcopy(@PathVariable Long id) {
		...
		bookcopyServices.deleteBookcopy(id); //call the service to delete the book copy by ID
