...
public class BookController {
	...
	public Optional<Book> getBookById(@PathVariable Long id) {
		...
		return bookServices.getBookById(id); //call the service to get the book by ID
	...
	public Book updateBook(@PathVariable Long id, @RequestBody Book book) {
		...
		// It will receive a Book object from the request body
		return bookServices.updateBook(id, book); //call the service to update the book
	...
	public void deleteBook(@PathVariable Long id) {
		...
		bookServices.deleteBook(id); //call the service to delete the book
